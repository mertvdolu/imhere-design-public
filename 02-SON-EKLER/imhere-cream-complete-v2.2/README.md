...
- **295 ekran durumu / 2360 SVG**: TR + EN × iOS + Android × %100 + %200.
...
- `l10n/`: tam referans sözlükleri, iki anahtarlık delta ve önceki alias/placeholder kurallarını koruyan migration.
