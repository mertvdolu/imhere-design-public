...
# Altıncı şikâyet kategorisi — 2026-09-24

Founder kararı: `reportChildSafety`.

- EN: Underage user or child safety
- TR: Reşit olmayan kullanıcı veya çocuk güvenliği
...
Yalnız `l10n/child-safety-patch_en.arb` ve `l10n/child-safety-patch_tr.arb` içindeki yeni anahtar ve açıklaması birleştirilmeli. Tam ARB dosyaları değiştirilmedi; üzerine yazılmamalı. `migration.json` sıralamayı ve delta dosyalarını belirtir.

Yerel commit; aktarımı Code yapar. Native uygulama bu teslimde değiştirilmedi.
